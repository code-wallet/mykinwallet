...
import logoUrl from '../assets/kin.svg';
...
<template>
    ...
    <header :class="classNames">
        ...
        <div class="h-11 w-11 inline-block align-top" >
          <img :src="logoUrl" />
        </div>
                    ...
                    <span class="ml-2 pt-[2px] text-2xl font-bold tracking-tight md:inline-block hidden">MyKinWallet</span>
                </a>
            </div>
